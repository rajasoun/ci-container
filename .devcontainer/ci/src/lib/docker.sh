...
function load_env_variables(){
    ...
    DOCKER_IMAGE="rajasoun/$(_get_app_name_from_git_workspace):$VERSION"
...
function build_container(){
    load_env_variables
    ## ToDo: Technical Debt: Hack - Force Setting Dockerfile
    ## This is done to build base docker image and publish to docker registry
    ## This PreBuilt Image is used as dev container for speed
    DOCKER_FILE_PATH="$CONFIG_DIR/Dockerfile"
